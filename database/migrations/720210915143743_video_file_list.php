...
class VideoFileList extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('video_author', 'string', ['limit' => 50,'null' => false,'default' => null,'signed' => true,'comment' => '视频作者',])
			->addColumn('video_name', 'string', ['limit' => 50,'null' => false,'default' => null,'signed' => true,'comment' => '视频名',])
