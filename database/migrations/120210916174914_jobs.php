...
class Jobs extends Migrator
{
    ...
    {
        $table = $this->table('jobs', ['engine' => 'InnoDB', 'collation' => 'utf8_general_ci', 'comment' => '' ,'id' => 'id' ,'primary_key' => ['id']]);
        $table->addColumn('queue', 'string', ['limit' => 255,'null' => false,'default' => null,'signed' => true,'comment' => '',])
			...
			->addColumn('attempts', 'integer', ['limit' => MysqlAdapter::INT_REGULAR,'null' => false,'default' => null,'signed' => false,'comment' => '',])
			->addColumn('reserved', 'boolean', ['null' => false,'default' => 0,'signed' => false,'comment' => '',])
